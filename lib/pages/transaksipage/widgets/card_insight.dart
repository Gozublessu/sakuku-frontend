...
class _CardDeepInsightState extends State<CardDeepInsight> {
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 15),
              Expanded(
                child: _buildScrollableContent(data),
              ),
            ],
          ),
        );
  ...
  Widget _buildScrollableContent(dynamic data) {
      ...
      child: Scrollbar(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _sectionHeader("informasi Penjualan"),
              ...
              _metricBox(
                label: "Kategori",
                value: data.product.kategori,
                icon: Icons.category,
              ),
              const SizedBox(height: 8),
              _metricBox(
                label: "Produk Masuk",
                value: DateFormat('dd MMM yyyy').format(data.product.dateIn),
                icon: Icons.share_arrival_time_outlined,
              ),
              const SizedBox(height: 8),
              _metricBox(
                label: "Harga beli",
                value: rupiah(data.product.hargaBeli),
                icon: Icons.sell,
              ),
              const SizedBox(height: 8),
              _metricBox(
                label: "Harga jual",
                value: rupiah(data.product.hargaJual),
                icon: Icons.sell_outlined,
              ),
              const SizedBox(height: 8),
              _metricBox(
                label: "netto",
                value: data.product.netto,
                icon: Icons.label,
              ),
              const SizedBox(height: 8),
              _sectionHeader("Informasi Stok"),
              _metricBox(
                label: "Akumulasi stok",
                value: "${data.product.totalStokMasuk}",
                icon: Icons.inventory_rounded,
              ),
              const SizedBox(height: 8),
              // _metricBox(
              //   label: "Stok awal masuk",
              //   value: "${data.restockHistory.first.qty}",
